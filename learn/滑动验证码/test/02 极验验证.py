...
def get_image(driver, div_path,index=1):
    """
...
def merge_image(image_file, location_list,index=11):
    """
     拼接图片
    :param image_file:
    :param location_list:
...
# selenium 是自动化测试工具
# 1. 获取图片, 获取图片碎片的位置
image1_file, image1_location = get_image(driver, '//div[@class="gt_cut_fullbg gt_show"]/div',1)
image2_file, image2_location = get_image(driver, '//div[@class="gt_cut_bg gt_show"]/div',2)
print(image1_file, image1_location)
print(image2_file, image2_location)
# 2. 还原图片数据
image1 = merge_image(image1_file, image1_location,11)
image2 = merge_image(image2_file, image2_location,22)
# 3. 求出需要移动的距离
